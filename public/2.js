...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_6f78da88_js__ = __webpack_require__(68);
...
var isValid = function (elm) {
    if (elm.nodeType === 1) {
        ...
        for (var i = 0; i < elm.attributes.length; i++) {
            ...
            if (Object(__WEBPACK_IMPORTED_MODULE_1__utils_6f78da88_js__["d" /* i */])(val) && val.toLowerCase().indexOf('on') === 0) {
                return false;
            }
        }
...
var Icon = /** @class */ (function () {
    function Icon(hostRef) {
        Object(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["e" /* r */])(this, hostRef);
    ...
    Icon.prototype.loadIcon = function () {
        var _this = this;
        if (this.isVisible) {
            var url_1 = Object(__WEBPACK_IMPORTED_MODULE_1__utils_6f78da88_js__["c" /* g */])(this);
            if (url_1) {
        ...
        if (!this.ariaLabel) {
            var label = Object(__WEBPACK_IMPORTED_MODULE_1__utils_6f78da88_js__["b"])(this.name, this.icon, this.mode, this.ios, this.md);
    ...
    Icon.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["d" /* h */])(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["a" /* H */], { role: "img", class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color)), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, ((this.svgContent)
            ? Object(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["d" /* h */])("div", { class: "icon-inner", innerHTML: this.svgContent })
            : Object(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["d" /* h */])("div", { class: "icon-inner" }))));
    };
    ...
    Object.defineProperty(Icon.prototype, "el", {
        get: function () { return Object(__WEBPACK_IMPORTED_MODULE_0__index_e0fb4cab_js__["b" /* c */])(this); },
        enumerable: false,
        configurable: true
    });
